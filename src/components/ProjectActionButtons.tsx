  ...
  return (
    <div className="space-y-3 pt-2">
      <div className="flex flex-wrap items-center gap-3">
        {/* Tombol Demo Utama */}
        {demoUrl ? (
          <div className="relative inline-flex rounded-xl shadow-lg shadow-emerald-500/10 group">
            <a
              href={demoUrl}
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2.5 px-5 py-2.5 rounded-l-xl bg-emerald-600 hover:bg-emerald-500 dark:bg-emerald-500 dark:hover:bg-emerald-400 text-white dark:text-zinc-950 font-mono font-bold text-xs transition-all tracking-tight"
            >
            ...
            <button
              ...
              className="px-3 rounded-r-xl bg-emerald-700 hover:bg-emerald-600 dark:bg-emerald-600 dark:hover:bg-emerald-500 text-white dark:text-zinc-950 border-l border-emerald-500/40 transition-colors flex items-center justify-center"
            >
              {copiedDemo ? (
          ...
          <button
            disabled
            className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl bg-zinc-100 dark:bg-zinc-800 text-zinc-400 dark:text-zinc-500 font-mono text-xs cursor-not-allowed border border-zinc-200 dark:border-zinc-700"
          >
        ...
        {repoUrl ? (
          <div className="relative inline-flex rounded-xl shadow-xs">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2.5 px-4 py-2.5 rounded-l-xl bg-zinc-100 dark:bg-zinc-800 hover:bg-zinc-200 dark:hover:bg-zinc-700 text-zinc-800 dark:text-zinc-200 font-mono text-xs font-semibold border border-r-0 border-zinc-300 dark:border-zinc-700 transition-colors"
            >
              <Code2 className="w-4 h-4 text-emerald-600 dark:text-emerald-400" />
              <span>Lihat Repository Kode</span>
              {stars && (
            ...
            <button
              ...
              className="px-2.5 rounded-r-xl bg-zinc-100 dark:bg-zinc-800 hover:bg-zinc-200 dark:hover:bg-zinc-700 text-zinc-700 dark:text-zinc-300 border border-zinc-300 dark:border-zinc-700 transition-colors flex items-center justify-center"
            >
              <ChevronDown className={`w-3.5 h-3.5 transition-transform ${showCloneDropdown ? "rotate-180" : ""}`} />
            </button>
          </div>
        ) : (
          <span className="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl bg-zinc-100 dark:bg-zinc-800/80 text-zinc-500 dark:text-zinc-400 font-mono text-xs border border-zinc-200 dark:border-zinc-700/60">
            <Lock className="w-3.5 h-3.5" />
            <span>Kode Sumber Privat (Proprietary)</span>
          </span>
        )}
      </div>
